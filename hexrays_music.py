...
class hexrays_callback_info(object):
    ...
    def __init__(self):
        self.vu = None
        self.highlights = {}
        # 0xF2E8BF #0x00ffff00       #ida's rgb is reversed  which is bgr
        self.hicolor = 0xffffff
...
class HexHLightPlugin_t(idaapi.plugin_t):
    ...
    def init(self):
        ...
        if idaapi.init_hexrays_plugin():
            ...
            #a = idaapi.Hexrays_Hooks()
            # print(a.func_printed)

            # if not idaapi.Hexrays_Hooks(hexlight_cb):
...
def PLUGIN_ENTRY():
    # return idaapi.PLUGIN_SKIP
    global sound_printed, sound_slip
    # song=AudioSegment.from_wav("reload1.wav")
    #song = mp3play.load("reload.mp3")
    pygame.mixer.init()
    sound_printed = pygame.mixer.Sound("reload1.mp3")
    sound_slip = pygame.mixer.Sound("slip.wav")
    sound_slip.set_volume(0.1)
    print("I'm in")
